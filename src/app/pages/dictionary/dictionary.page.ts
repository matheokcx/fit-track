...
import { IonContent, IonHeader, IonSearchbar, IonText, IonTitle, IonToolbar} from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonText, ExerciseFullInfosComponent, IonSearchbar]
})
