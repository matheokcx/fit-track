...
import { IonButton, IonContent, IonHeader, IonLabel, IonList, IonListHeader, IonTitle, IonToolbar, IonIcon, IonFooter, IonAlert } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, CommonModule, FormsModule, IonLabel, IonList, IonListHeader, WorkoutItemComponent, IonToolbar, IonHeader, IonTitle, IonButton, IonIcon, IonFooter, IonAlert]
})
